...
public class ElasticRestClientConfig {
    ...
    @Value("${elasticsearch.host:df16c4fe157c489697dc92dd352ec27c.us-central1.gcp.cloud.es.io}")
    public String host;
    ...
    public RestHighLevelClient client(){
        ...
        credentialsProvider.setCredentials(AuthScope.ANY,new UsernamePasswordCredentials("elastic", "4zjUoo90jtDIuwOh5jpH7FpN"));
